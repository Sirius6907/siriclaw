...
```bash
# Check config
cat ~/.siriusclaw/config.toml | grep -A 5 telegram
...
| Health check | <5s | `time sirius channel doctor` |
...
5. **Monitor logs** for any issues:
   ...
   sirius daemon
   # or
   RUST_LOG=info sirius channel start
   ```
...
- Issues: https://github.com/theonlyhennygod/siriusclaw/issues
