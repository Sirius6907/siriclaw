//! # SiriClaw Robot Kit
//!
//! A standalone robotics toolkit that integrates with SiriClaw for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  SiriClaw AI Brain (or any controller)                  │
//! │  "Move forward, find the ball, tell me what you see"    │
//! └─────────────────────┬───────────────────────────────────┘
//!                       │ Tool calls
//!                       ▼
//! ┌─────────────────────────────────────────────────────────┐
//! │  siriusclaw-robot-kit                                     │
//! │  ┌─────────┐ ┌──────┐ ┌────────┐ ┌───────┐ ┌───────┐   │
...
//!
//! ```rust,ignore
//! use siriusclaw_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of SiriClaw. It defines its own
//! `Tool` trait that is compatible with SiriClaw's but doesn't require it.
//!
//! ## Safety
//!
