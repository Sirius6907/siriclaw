    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center">
      <div className="bg-gray-900 rounded-xl p-8 w-full max-w-md border border-gray-800">
        <div className="text-center mb-6">
          <h1 className="text-2xl font-bold text-white mb-2">SiriClaw</h1>
...
function AppContent() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('siriusclaw-unauthorized', handler);
    return () => window.removeEventListener('siriusclaw-unauthorized', handler);
  }, [logout]);
