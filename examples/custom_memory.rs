//! Example: Implementing a custom Memory backend for SiriClaw
//!
...
// ── Re-define the trait types (in your app, import from siriusclaw::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 SiriClaw Memory Demo — InMemoryBackend\n");
