# SiriClaw ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for SiriClaw edge scenarios on ESP32.
...
```bash
cd firmware/siriusclaw-esp32-ui
cargo build --release
...
3. Connect UI state with SiriClaw edge/runtime messaging
...
- [SiriClaw Hardware Design](../../docs/hardware-peripherals-design.md)
