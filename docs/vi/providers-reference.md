# Tài liệu tham khảo Providers — SiriClaw
...
3. Biến môi trường dự phòng chung: `SIRIUSCLAW_API_KEY`, sau đó là `API_KEY`
...
- Sau khi chuẩn hóa multimodal, SiriClaw gửi payload hình ảnh qua trường `messages[].images` gốc của Ollama.
- Nếu chọn provider không hỗ trợ vision, SiriClaw trả về lỗi rõ ràng thay vì âm thầm bỏ qua hình ảnh.
...
- Khám phá model: `sirius models refresh --provider nvidia`
