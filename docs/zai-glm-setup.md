...
SiriClaw supports Z.AI's GLM models through OpenAI-compatible endpoints.
This guide covers practical setup options that match current SiriClaw provider behavior.

## Overview

SiriClaw supports these Z.AI aliases and endpoints out of the box:
...
### Test with SiriClaw CLI

```bash
# Test agent directly
echo "Hello" | sirius agent
