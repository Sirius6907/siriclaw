# SiriClaw PR Workflow (High-Volume Collaboration)

This document defines how SiriClaw handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to SiriClaw/project-native labels.
...
- Confirm any required identity-like wording uses SiriClaw/project-native terminology.
