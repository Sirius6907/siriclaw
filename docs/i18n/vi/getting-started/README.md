...
| Tình huống | Lệnh |
|----------|---------|
| Có API key, muốn cài nhanh nhất | `sirius onboard --api-key sk-... --provider openrouter` |
| Muốn được hướng dẫn từng bước | `sirius onboard --interactive` |
| Đã có config, chỉ cần sửa kênh | `sirius onboard --channels-only` |
...
- Thiết lập nhanh: `sirius onboard --api-key "sk-..." --provider openrouter`
- Thiết lập tương tác: `sirius onboard --interactive`
- Kiểm tra môi trường: `sirius status` + `sirius doctor`
