...
Cách cài đặt và khởi tạo SiriClaw nhanh nhất.
...
Mặc định là **chỉ ứng dụng** (build/cài SiriClaw), yêu cầu Rust toolchain sẵn có.
...
Lệnh này build image SiriClaw cục bộ và chạy thiết lập trong container, lưu config/workspace vào `./.siriusclaw-docker`.
