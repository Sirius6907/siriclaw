...
## Problem
SiriClaw logs actions but lacks tamper-evident audit trails for:
...
# Tamper evidence
sign_events = true
signing_key_path = "~/.config/siriusclaw/audit.key"
...
siriusclaw audit --user @alice

# Show all high-risk commands
siriusclaw audit --risk high

# Show violations from last 24 hours
siriusclaw audit --since 24h --violations-only

# Export to JSON for analysis
siriusclaw audit --format json --output audit.json
