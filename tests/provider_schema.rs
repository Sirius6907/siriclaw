...
use siriusclaw::providers::compatible::AuthStyle;
use siriusclaw::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use siriusclaw::providers::compatible::OpenAiCompatibleProvider;
