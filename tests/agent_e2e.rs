...
//!
//! Ref: https://github.com/siriclaw-labs/siriusclaw/issues/618 (item 6)
...
use siriusclaw::agent::dispatcher::{NativeToolDispatcher, XmlToolDispatcher};
use siriusclaw::agent::memory_loader::MemoryLoader;
use siriusclaw::config::MemoryConfig;
use siriusclaw::memory;
use siriusclaw::memory::Memory;
use siriusclaw::observability::{NoopObserver, Observer};
use siriusclaw::providers::traits::ChatMessage;
use siriusclaw::providers::{
...
async fn e2e_multi_turn_with_memory_enrichment() {
    ...
    assert!(req1_user.content.contains("project: siriusclaw"));
...
async fn e2e_live_openai_codex_multi_turn() {
    use siriusclaw::providers::openai_codex::OpenAiCodexProvider;
    use siriusclaw::providers::traits::Provider;
