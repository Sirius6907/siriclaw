# SiriClaw Contributor License Agreement (CLA)
...
property rights granted by contributors to Chandan Kumar Behera. This agreement
protects both contributors and users of the SiriClaw project.

By submitting a contribution (pull request, patch, issue with code, or any
other form of code submission) to the SiriClaw repository, you agree to the
terms of this CLA.
...
- **"Contribution"** means any original work of authorship, including any
  modifications or additions to existing work, submitted to Chandan Kumar Behera
  for inclusion in the SiriClaw project.

- **"You"** means the individual or legal entity submitting a Contribution.

- **"Chandan Kumar Behera"** means the maintainers and organization responsible
  for the SiriClaw project at https://github.com/Sirius6907/siriclaw.

---

## 2. Grant of Copyright License

You grant Chandan Kumar Behera and recipients of software distributed by Chandan Kumar Behera
...
the SiriClaw project.

**This protects you:** if a third party files a patent claim against
SiriClaw that covers your Contribution, your patent license to the project
is not revoked.
...
This CLA does **not** transfer ownership of your Contribution to Chandan Kumar Behera.
You retain full copyright ownership of your Contribution. You are
...
3. If your employer has rights to intellectual property you create, you
   ...
   has signed a corporate CLA with Chandan Kumar Behera.

---

## 6. No Trademark Rights

This CLA does not grant you any rights to use the SiriClaw name,
...
Chandan Kumar Behera will maintain attribution to contributors in the repository
...
All Contributions accepted into the SiriClaw project are licensed under
both:
...
By opening a pull request or submitting a patch to the SiriClaw repository,
...
https://github.com/Sirius6907/siriclaw/issues

---

*This CLA is based on the Apache Individual Contributor License Agreement
v2.0, adapted for the SiriClaw dual-license model.*
