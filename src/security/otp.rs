...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(siriusclaw_dir);
...
pub fn secret_file_path(siriusclaw_dir: &Path) -> PathBuf {
    siriusclaw_dir.join(OTP_SECRET_FILE)
}
