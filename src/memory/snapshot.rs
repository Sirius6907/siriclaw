...
const SNAPSHOT_HEADER: &str = "# 🧠 SiriClaw Memory Snapshot\n\n\
    > Auto-generated by SiriClaw. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 SiriClaw Memory Snapshot

> Auto-generated by SiriClaw.
...
I am SiriClaw, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 SiriClaw Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
